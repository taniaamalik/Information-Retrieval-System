...
#membaca file korpus
corpus = open('D:/Tania/UB/Semester 6/Tania/STKI/Tugas/Tugas 3/corpus.txt', 'rt', encoding="ANSI")
readCorpus = corpus.read()
corpus.close()

#Membaca kamus kata
kamusKata = open('D:/Tania/UB/Semester 6/Tania/STKI/Tugas/Tugas 3/KamusKataDasar.txt', 'rt',)
